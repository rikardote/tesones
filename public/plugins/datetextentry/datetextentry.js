...
(function($){
    ...
    $.fn.datetextentry.defaults = {
        ...
        tooltip_x             : 0,
        tooltip_y             : 6,
        field_tip_text_day    : 'Dia',
        field_tip_text_month  : 'Mes',
        field_tip_text_year   : 'Año',
        field_hint_text_day   : 'DD',
        field_hint_text_month : 'MM',
        field_hint_text_year  : 'AAAA',
        E_DAY_NAN             : 'Dia debe ser numerico',
        E_DAY_TOO_BIG         : 'Dia solo del 1-31',
        E_DAY_TOO_SMALL       : 'Day solo del 1-31',
        E_BAD_DAY_FOR_MONTH   : 'Only %d days in %m %y',
        E_MONTH_NAN           : 'Mes debe ser numerico',
        E_MONTH_TOO_BIG       : 'Mes solo del 1-12',
        E_MONTH_TOO_SMALL     : 'Mes solo del 1-12',
        E_YEAR_NAN            : 'Año debe ser numberico',
        E_YEAR_LENGTH         : 'Año debe ser de 4 digitos',
